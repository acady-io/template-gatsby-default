...
export default class IndexPage extends React.Component<PageProps, any> {
    ...
    render() {
        return (
            <main className={indexStyles.page}>
                <title>Home Page</title>
                <img className={indexStyles.acadyLogo} src="images/acady.svg" width="300"/>
                ...
                <p className={indexStyles.paragraph}>
                    Edit <code className={indexStyles.code}>src/pages/index.tsx</code> to see this page
                    update in real-time.{" "}
                    <span role="img" aria-label="Sunglasses smiley emoji">😎</span>
                </p>
                <ul className={indexStyles.list}>
                    <li className={indexStyles.docLink}>
                        <a
                    ...
                    {links.map(link => (
                        <li className={indexStyles.listItem} style={{color: link.color}}>
            <span>
              <a
                  className={indexStyles.link}
              ...
              <p className={indexStyles.description}>{link.description}</p>
            </span>
                        </li>
                    ))}
                </ul>
